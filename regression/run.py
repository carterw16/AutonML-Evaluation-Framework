...
regression_tasks = openml.tasks.list_tasks(task_type=openml.tasks.TaskType.SUPERVISED_REGRESSION)  # Task type id 1 corresponds to regression tasks
ids = [task_id for task_id, _ in regression_tasks.items()]
# ids = [823]
# timelimits=[60]
...
for id in ids:
    ...
    try:
      ...
      eval_task_dir = os.path.join(os.getcwd(), "Task_", str(id), "/")
